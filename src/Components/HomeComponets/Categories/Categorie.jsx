  ...
  return (
    <div>
      <div
        ...
        className=" cursor-pointer  card w-4/4 text-primary-content rounded-xl py-20 px-8 shadow-xl   hover:shadow-2xl hover:bg-[#19A463] hover:text-white bg-[#fff] transition"
      >

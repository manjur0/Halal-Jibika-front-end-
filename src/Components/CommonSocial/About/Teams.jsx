const Teams = () => {
  return (
    <div>
      <section className="bg-white dark:bg-[#19a4631a] text-black">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
          <div className="mx-auto  text-left mb-8 lg:mb-16">
            <h4 className="text-[#19A463] text-lg">Team Management</h4>
            <h2 className="mb-4 text-5xl tracking-tight font-extrabold  dark:text-800  text-[#111D3B]">
              Our Creative Team
            </h2>
          </div>
          <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 text-black">
            ...
            >
              <a href="#">
                <img
                  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg"
                  src="https://powerpackelements.com/wp-content/uploads/2017/11/Team-memeber-2-e1510727045494.png"
                  alt="Jese Avatar"
                />
              </a>
              <div className="p-5">
            ...
            >
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-[#111D3B]">
                  <a href="#">Michael Gough</a>
                </h3>
                <span className="text-gray-500 dark:text-[#111D3B]">
                  Senior Front-end Developer
                </span>
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-[#111D3B]">

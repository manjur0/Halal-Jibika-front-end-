...
const AddJobs = ({ applyedJob }) => {
  ...
  const { id, way, logo, title, location, salary, position, description } =
    applyedJob;
  ...
  return (
    <div>
      <div className="  relative flex bg-clip-border rounded-xl bg-white text-gray-700 shadow-md  max-w-[48rem] flex-row">
